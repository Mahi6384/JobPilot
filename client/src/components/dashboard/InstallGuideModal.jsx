...
export default function InstallGuideModal({ isOpen, onClose }) {
  return (
    <Modal open={isOpen} onClose={onClose} title="Install JobPilot Extension" size="md">
...
function Step({ number, icon, title, desc }) {
  return (
    <div className="flex gap-3 items-start p-3 rounded-xl bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] transition-colors">
